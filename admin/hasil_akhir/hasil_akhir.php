 ...
 <section class="layanan">
          ...
          <div class="section-title">
            ...
            <p> Disini kami selaku panitia dari PEMIRA mencoba untuk transparans mengenai hasil pemungutan suara dari pemilihan
                ketua hima 2023. Hal ini juga sebagai menjalankan salah satu azas dari PEMIRA yakni jujur dan adil.
...
<div class="container-fluid">
	...
	<?php 
		...
		//Angkatan 2023
		//Teknik Informatika
		$sql_seluruh_mahasiswaTI2023 = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'teknik informatika'");
		$sql_seluruh_mahasiswaTI2023sudah = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'teknik informatika' 
		AND status_pencoblosan = 1");
		$sql_seluruh_mahasiswaTI2023belum = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'teknik informatika' 
		AND status_pencoblosan = 0");
		$data_seluruh_mahasiswaTI2023 = mysqli_num_rows($sql_seluruh_mahasiswaTI2023);
		$data_seluruh_mahasiswaTI2023sudah = mysqli_num_rows($sql_seluruh_mahasiswaTI2023sudah);
		$data_seluruh_mahasiswaTI2023belum = mysqli_num_rows($sql_seluruh_mahasiswaTI2023belum);

		//Teknologi Hasil Pertanian
		$sql_seluruh_mahasiswaTHP2023 = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'teknologi hasil pertanian'");
		$sql_seluruh_mahasiswaTHP2023sudah = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'teknologi hasil pertanian' 
		AND status_pencoblosan = 1");
		$sql_seluruh_mahasiswaTHP2023belum = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'teknologi hasil pertanian' 
		AND status_pencoblosan = 0");
		$data_seluruh_mahasiswaTHP2023 = mysqli_num_rows($sql_seluruh_mahasiswaTHP2023);
		$data_seluruh_mahasiswaTHP2023sudah = mysqli_num_rows($sql_seluruh_mahasiswaTHP2023sudah);
		$data_seluruh_mahasiswaTHP2023belum = mysqli_num_rows($sql_seluruh_mahasiswaTHP2023belum);

		//Akuntansi
		$sql_seluruh_mahasiswaAKN2023 = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'akuntansi'");
		$sql_seluruh_mahasiswaAKN2023sudah = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'akuntansi' 
		AND status_pencoblosan = 1");
		$sql_seluruh_mahasiswaAKN2023belum = mysqli_query($koneksi,"SELECT * FROM tb_pencoblos 
		WHERE tahun_angkatan = '2023' 
		AND prodi_pencoblos = 'akuntansi' 
		AND status_pencoblosan = 0");
		$data_seluruh_mahasiswaAKN2023 = mysqli_num_rows($sql_seluruh_mahasiswaAKN2023);
		$data_seluruh_mahasiswaAKN2023sudah = mysqli_num_rows($sql_seluruh_mahasiswaAKN2023sudah);
		$data_seluruh_mahasiswaAKN2023belum = mysqli_num_rows($sql_seluruh_mahasiswaAKN2023belum);

		//jumlah banyak pemilih tiap kandidat
      					...
      					<div class="col-lg-12">
      				    	<div class="p-5">
						  		<div class="text-center">
								  	<h2 class="p-5">CALON NOMOR <?php echo $no++ ?></h2>
              						<ul>
									...
									<div class="card">
  										<h5 class="text-start card-header">Total Banyak Suara</h5>
  										<div class="text-start card-body">
											<div class="row">
												...
												<div class="col-6">
													<p class="card-text text-end"><?php echo $banyak_pencoblos; ?></p>
												</div>
											</div>
  										</div>
									</div>
						  	...
						  	<div class="text-center p-5">
								...
								<h5 class="fw-bold">
								  ...
								  <ul class="list-inline py-3">
                                        ...
                                        <li class="list-inline-item">
                                            <h6><?php echo $data_seluruh_mahasiswaTI2023;?></h6>
                                            <h6><?php echo $data_seluruh_mahasiswaTI2023sudah;?></h6>
                                            <h6><?php echo $data_seluruh_mahasiswaTI2023belum;?></h6>
                                        </li>
                                    </ul>
								...
								<h5 class="fw-bold">
								  ...
								  <ul class="list-inline py-3">
                                        ...
                                        <li class="list-inline-item">
                                            <h6><?php echo $data_seluruh_mahasiswaTHP2023;?></h6>
                                            <h6><?php echo $data_seluruh_mahasiswaTHP2023sudah;?></h6>
                                            <h6><?php echo $data_seluruh_mahasiswaTHP2023belum;?></h6>
                                        </li>
                                    </ul>
								...
								<h5 class="fw-bold">
								  ...
								  <ul class="list-inline py-3">
                                        ...
                                        <li class="list-inline-item">
                                            <h6><?php echo $data_seluruh_mahasiswaAKN2023;?></h6>
                                            <h6><?php echo $data_seluruh_mahasiswaAKN2023sudah;?></h6>
                                            <h6><?php echo $data_seluruh_mahasiswaAKN2023belum;?></h6>
                                        </li>
                                    </ul>
